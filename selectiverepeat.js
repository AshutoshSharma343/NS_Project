function initSelectiveRepeatSimulation() {
     const simulationContainer = document.getElementById('simulation-container');
 
     // Create elements for the simulation
     const title = document.createElement('h3');
     title.textContent = 'Selective Repeat Simulation';
       ...
       function(e, t, n) {
         ...
         !(function(t, n) {
           ...
           function S(e, t, n, i) {
             ...
             if (
               v ||
               (d > 1 && "string" == typeof f && !ae.checkClone && Ke.test(f))
             )
           ...
           function N(e) {
             ...
             return (
               n ||
                 ...
                 ("none" !== n && n) ||
                   ((Ge = (
                     Ge || le("<iframe frameborder='0' width='0' height='0'/>")
            ...
            */ (function(e) {
             function t(e, t, n, i) {
               ...
               if (
                 !i &&
                 ((t ? t.ownerDocument || t : F) !== D && R(t), (t = t || D), j)
               ) {
                 if (11 !== v && (l = me.exec(e)))
                   if ((r = l[1])) {
                     if (9 === v) {
               ...
               var r = n.length > 0,
                 ...
                 s = function(i, s, a, c, l) {
                   ...
                   for (
                     ...
                     if (o && u) {
                       for (
                         d = 0, s || u.ownerDocument === D || (R(u), (a = !j));
                         (p = e[d++]);
                   ...
                   if (((f += h), r && h !== f)) {
                     ...
                     if (i) {
                       if (f > 0) for (; h--; ) v[h] || m[h] || (m[h] = G.call(c));
                       m = g(m);
                     }
                     Q.apply(c, m),
                       l &&
             ...
             (k = t.support = {}),
               ...
               (R = t.setDocument = function(e) {
                 ...
                 return i !== D && 9 === i.nodeType && i.documentElement
                   ? ((D = i),
                     ...
                     (I = []),
                     (q = []),
                     (k.qsa = ge.test(D.querySelectorAll)) &&
                       (r(function(e) {
                           ...
                           return n
                             ...
                             : ((n =
                               ...
                               (!k.sortDetached &&
                                 ...
                                 ? e === D || (e.ownerDocument === F && M(F, e))
                                   ? -1
                                   : t === D || (t.ownerDocument === F && M(F, t))
                                   ? 1
                                   : N
                                   ? ee(N, e) - ee(N, t)
                                   : 0
               ...
               (t.contains = function(e, t) {
                 return (e.ownerDocument || e) !== D && R(e), M(e, t);
               }),
               (t.attr = function(e, t) {
                 (e.ownerDocument || e) !== D && R(e);
                 var n = w.attrHandle[t.toLowerCase()],
                   i =
                     n && Y.call(w.attrHandle, t.toLowerCase())
                       ? n(e, t, !j)
                       : void 0;
                 return void 0 !== i
                   ? i
               ...
               function(e, t) {
                 le.fn[e] = function(n, i) {
                   ...
                   return (
                     ...
                     this.length > 1 &&
                       (Te[e] || le.uniqueSort(r), Pe.test(e) && r.reverse()),
                     this.pushStack(r)
                   );
                 };
               }
                       ...
                       function(t) {
                         ...
                         if (o && void 0 === t) {
                           if (
                             ((n =
                               Ee.get(o, e) ||
                               Ee.get(o, e.replace(De, "-$&").toLowerCase())),
                             void 0 !== n)
                           )
                             return n;
                           if (
           ...
           le.extend({
             ...
             style: function(e, t, n, i) {
               if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                 var r,
                   ...
                   c = e.style;
                 return (
                   (t = le.cssProps[a] || (le.cssProps[a] = D(a) || a)),
             ...
             le.each({ margin: "", padding: "", border: "Width" }, function(e, t) {
               (le.cssHooks[e + t] = {
                 ...
                 Qe.test(e) || (le.cssHooks[e + t].set = L);
             }),
             le.fn.extend({
               css: function(e, t) {
                 return Ae(
           ...
           le.fn.extend({
             addClass: function(e) {
               ...
               if (le.isFunction(e))
                 return this.each(function(t) {
                   le(this).addClass(e.call(this, t, U(this)));
                 });
             ...
             removeClass: function(e) {
               ...
               if (le.isFunction(e))
                 return this.each(function(t) {
                   le(this).removeClass(e.call(this, t, U(this)));
                 });
             ...
             toggleClass: function(e, t) {
               ...
               return "boolean" == typeof t && "string" === n
                 ...
                 ? this.each(function(n) {
                     le(this).toggleClass(e.call(this, n, U(this), t), t);
                   })
                 : this.each(function() {
                     var t, i, r, o;
                     if ("string" === n)
                       for (
                         i = 0, r = le(this), o = e.match(Ce) || [];
                         (t = o[i++]);
           ...
           d.prototype = {
                 ...
                 this.isRender ||
                   ...
                   t(document).ready(function() {
                     e.initButtons.call(e),
                       ...
                       e.updateElements();
                     var n =
                       "With this interactive animation, you can explore Selective Repeat Protocol, which provides reliable data transfer using selective acknowledgments, and both sending and receiving windows sizes are greater than 1. There is a scheme that shows the sender and the receiver in front of each other. There are 19 small vertical rectangular shapes put in line on each side. They represent the data packets.The sending window limits the sender to a maximum of 5 outstanding data packets. To show that, on the sender side the first five packets are combined with a thin frame. Thus, the base equals 1 in the beginning. For no packet has been sent yet, the next number in a sequence also equals to 1.The five rectangles are framed the same way on the receiver side, for the receiving window size equals 5.There are 6 control buttons above the scheme.The Send New button runs the animation and creates the new data packet. When you click on this button, the data packets begin moving between the sender and the receiver.The Pause button freezes the animation. With the Faster and Slower buttons you can change the animation speed rate. With the Kill Packet or Ack button, you can simulate loss. To do so, select a moving data packet or acknowledgement, and then press this button. You can use Pause to make selecting easier.The last one is the Resume button. Clicking on it continues the animation from the point at which it has been paused.";
                     t(".navigation").text(n),
             ...
             resetBoard: function() {
               ...
               this.stopTimer(),
                 ...
                 (this.receivePackets.lastPacketId = -1),
                 (this.senderPackets.lastPacketId = -1),
             ...
             packetReceived: function(e, t) {
               var n = e.cell,
                 i = e.cell.id,
                 o = t.receivePackets.currentPositionInArray,
                 s = t.receivePackets.maxCountSenderPacket,
                 a = t.receivePackets.lastPacketId;
               if (o > i)
                 return (
                   t.sendOnePacket(
                     e.cellWhere.id,
               ...
               if (i >= o && o + s > i) {
                 if (i == a + 1) {
                   t.voice.speak(
                     ...
                     o < t.countCells - s &&
                       (t.receivePackets.currentPositionInArray++, o++);
                   for (var c = i + 1; c < t.allCells.receive.length; c++) {
                     var n = t.allCells.receive[c];
                     "buffered" == n.status
                       ? (n.setStatus("received"),
                         t.voice.speak(
                           this.getResultMessage(r.buffered_delivered.voice, [
                             n.id,
                             r.at_the_receiver_side
                           ])
                         ),
                         t.addLog(
                           this.getResultMessage(r.buffered_delivered.text, [
                             r.R,
                             n.id
                           ])
                         ),
                         ...
                         o < t.countCells - s &&
                           (t.receivePackets.currentPositionInArray++, o++))
                       : (c = t.allCells.receive.length);
                   }
                   return;
                 }
                 return (
                   i >= a &&
                     (e.cellWhere.setStatus("buffered"),
                     t.voice.speak(
                       this.getResultMessage(r.packet_buffered.voice, [
                         n.id,
                         n.id,
                         r.at_the_receiver_side
                       ])
                     ...
                     t.addLog(
                       this.getResultMessage(r.packet_buffered.text, [
                         r.R,
                         n.id,
                         n.id
                       ])
                     )),
                   void t.sendOnePacket(
                     e.cellWhere.id,
                     e.cell.id,
                     "receive",
                     "ack",
             ...
             ackPacketReceived: function(e, t) {
               var n = e.cell,
                 i = e.cell.id,
                 o = t.senderPackets.currentPositionInArray,
                 s = t.senderPackets.maxCountSenderPacket,
                 a = t.senderPackets.lastPacketId;
               if (
                 (o > i && e.cellWhere.setStatus("ackReceived"),
                 i >= o && o + s > i)
               ) {
                 if (i == a + 1) {
                   e.cellWhere.setStatus("ackReceived"),
                     t.voice.speak(
                   ...
                   for (var c = i + 1; c < t.allCells.sender.length; c++) {
                     var n = t.allCells.sender[c];
                     "ackReceived" == n.status
                       ? ((t.senderPackets.lastPacketId = n.id),
                         o < t.countCells - s - 1 &&
                           (t.senderPackets.currentPositionInArray++,
                           t.senderPackets.currentCountSenderPackets--,
               ...
               this.allCells.sender.forEach(function(a) {
                 ...
                 "waiting" == c &&
                   ...
                   t &&
                     ...
                     i.addLog(
                       i.getResultMessage(r.timeout_occured.text, [
                         r.S,
                         a.id,
                         a.id
                       ])
       ...
       function(e, t) {
         var n = {
           ...
           start_timer_for_packet: {
             text: "%s Timer started for Packet %s.",
             voice: "Timer started for Packet %s %s."
           },
           cumulative_ack_for_packet_is_sent: {
             text:
               "Cumulative Ack for Packet %s is sent. Click key Num%s to kill this ack. ",
             voice:
               "Cumulative Ack for Packet %s is sent %s. Click key Num%s to kill this ack. "
           },
           packet_sent: {
           ...
           packet_received_out_of_order: {
             text:
               "%s Packet %s received out of order. Selective acknowledge for only Packet %s sent again(DUPACK). ",
             voice:
               "Packet %s received out of order. Selective acknowledge for only Packet %s sent again(DUPACK) %s."
           },
           ...
           packet_received: {
             text:
               "%s Packet %s received. Selective acknowledge for only Packet %s sent. Packet %s delivered to application.",
             voice:
               "Packet %s received. Selective acknowledge for only Packet %s sent. Packet %s delivered to application %s."
           },
           packet_buffered: {
             text:
               "%s Packet %s received out of order. Packet buffered. Selective acknowledge for only Packet %s sent.",
             voice:
               "Packet %s received out of order. Packet buffered. Selective acknowledge for only Packet %s sent %s."
           },
           cumulative_ack_received: {
             text:
               "%s Selective ACK for only Packet %s received. Timer for Packet %s stopped.",
             voice:
               "Selective ACK for only Packet %s received. Timer for Packet %s stopped %s."
           },
           buffered_delivered: {
             text: "%s Buffered Packet %s delivered to application.",
             voice: "Buffered Packet %s delivered to application %s."
           },
           ...
           timeout_occured: {
             text:
               "%s Timeout occurred for Packet %s. Timer restarted for Packet %s. ",
             voice:
               "Timeout occurred for Packet %s. Timer restarted for Packet %s %s."
           },
           ...
           <div class="applet" aria-labelledby="navigation">
             ...
             <div class="animation">
               ...
               <div class="top-label" aria-hidden="true">
                 \r\n
                 <p class="blue" aria-hidden="true">Sender <br/> (Send Window Size = 5) <br/> Timeout = 10s</p>
